object dm: Tdm
  ...
  object qryContracts: TUniQuery
    ...
    SQLRefresh.Strings = (
        ...
        #1094#1080#1086#1083#1086#1075#1080#1095#1077#1089#1082#1080#1093' '#1086#1087#1088#1086#1089#1086#1074#39
      '         WHEN A.AGREEMENT_KIND = 1 THEN '#39#1058#1072#1081#1085#1099#1081' '#1087#1086#1082#1091#1087#1072#1090#1077#1083#1100#39
      
        '         WHEN A.AGREEMENT_KIND = 2 THEN '#39#1056#1072#1073#1086#1090#1072' '#1087#1086' '#1087#1088#1086#1074#1077#1076#1077#1085#1080#1102' '#1089#1086 +
        #1094#1080#1086#1083#1086#1075#1080#1095#1077#1089#1082#1080#1093' '#1086#1087#1088#1086#1089#1086#1074' '#1074' '#1082#1086#1083#1083'-'#1094#1077#1085#1090#1088#1077#39
      '    END AS KIND'
      ' FROM AGREEMENTS'
      'WHERE'
